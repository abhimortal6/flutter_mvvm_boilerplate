...
class _CustomURLViewState extends State<CustomURLView> {
  ...
  void initState() {
    ...
    super.initState();
    Provider.of<CustomURLViewModel>(context, listen: false)
        .checkIfURLSetPreviously();
  }

  @override
  Widget build(BuildContext context) {
    CustomURLViewModel _customURLViewModel =
        Provider.of<CustomURLViewModel>(context);
    return Scaffold(
      appBar: AppBar(
